...
- (void)layoutSubviews
{
    ...
    self.placehoderLabel.mj_w = self.mj_w - 2 * self.placehoderLabel.mj_x;
    // 根据文字计算label的高度
    CGSize maxSize = CGSizeMake(self.placehoderLabel.mj_w, MAXFLOAT);
    CGSize placehoderSize = [self.placehoder sizeWithFont:self.placehoderLabel.font constrainedToSize:maxSize];
    self.placehoderLabel.mj_h = placehoderSize.height;
}
/*
